...
class TestDiscoverPackagesAndPyModules:
    ...
    FILES = {
        "src": ["src/pkg/__init__.py", "src/pkg/chunk_vecto_chromadb.py"],
        "lib": ["lib/pkg/__init__.py", "lib/pkg/chunk_vecto_chromadb.py"],
        "flat": ["pkg/__init__.py", "pkg/chunk_vecto_chromadb.py"],
