...
class TestReadAttr:
    ...
    def test_import_order(self, tmp_path):
        ...
        files = {
            ...
            "src/pkg/chunk_vecto_chromadb.py": "import super_complicated_dep\ndef func(): return 42",
...
@pytest.mark.parametrize(
    ...
    [
        ({"": "src"}, "src/pkg/chunk_vecto_chromadb.py", "pkg.main", 42),
        ({"pkg": "lib"}, "lib/chunk_vecto_chromadb.py", "pkg.main", 13),
